...
#include "..\..\include\Viewstate_Element\Text_Elements\Viewstate_Element_Text_ScheduledTaskList_Edit.h"
...
Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView::Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView(IModelViewstateData * viewstateData, IModelTaskData * taskData) :
	Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_SCHEDULED_TASK_DELETE_TASK_VIEW), _viewstateData(viewstateData), _taskData(taskData){}

Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView::~Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView(){}

char * Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	...
	if(selectedViewstateElementIndex < 3)
	{
		...
		Viewstate_Element_Text_ScheduledTaskList_Edit _scheduledTaskListEdit{ 22, 1, _taskData, _viewstateData };
		_scheduledTaskListEdit.emplace(vs_OutBuffer, outBufferSize);
	}
	else
	{
		Viewstate_Element_Text_ScheduledTaskList_Edit _scheduledTaskListEdit{ 1, 1, _taskData, _viewstateData };
		_scheduledTaskListEdit.emplace(vs_OutBuffer, outBufferSize);
	}
