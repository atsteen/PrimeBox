...
Viewstate_PX4_ScheduledTasksConfig_EditTaskView::Viewstate_PX4_ScheduledTasksConfig_EditTaskView(IModelViewstateData * viewstateData, IModelTaskData * taskData) :
	Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_SCHEDULED_TASK_EDIT_EXISTING_VIEW), _viewstateData(viewstateData), _taskData(taskData){}

Viewstate_PX4_ScheduledTasksConfig_EditTaskView::~Viewstate_PX4_ScheduledTasksConfig_EditTaskView(){}

char * Viewstate_PX4_ScheduledTasksConfig_EditTaskView::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
