...
Viewstate_PX4_EnvironmentSettingsView_TLMV::Viewstate_PX4_EnvironmentSettingsView_TLMV() : Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_ENVIRONMENT_SETTINGS_VIEW_TLMV){}

Viewstate_PX4_EnvironmentSettingsView_TLMV::~Viewstate_PX4_EnvironmentSettingsView_TLMV(){}

char * Viewstate_PX4_EnvironmentSettingsView_TLMV::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	_clearBuffer(vs_OutBuffer, outBufferSize);

	Viewstate_Element_Text_DynamicText _dynamicTextVE_TLMV_TitleLine1{ 22, 0, ENV_SETTINGS_TLMV_TEXT_TITLE };
	Viewstate_Element_Text_DynamicText _dynamicTextVE_TLMV_TitleLine2{ 43, 0, DEFAULT_TLMV_TEXT_SETTINGS };
	...
	_vsDynElements.AddElement(&_dynamicTextVE_TLMV_TitleLine1);
	_vsDynElements.AddElement(&_dynamicTextVE_TLMV_TitleLine2);
