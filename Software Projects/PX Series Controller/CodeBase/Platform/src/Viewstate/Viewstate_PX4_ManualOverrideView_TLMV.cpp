...
Viewstate_PX4_ManualOverrideView_TLMV::Viewstate_PX4_ManualOverrideView_TLMV() : Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_MANUAL_OVERRIDE_VIEW_TLMV){}

Viewstate_PX4_ManualOverrideView_TLMV::~Viewstate_PX4_ManualOverrideView_TLMV(){}

char * Viewstate_PX4_ManualOverrideView_TLMV::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	_clearBuffer(vs_OutBuffer, outBufferSize);

	//create viewstate elements { start_index, inbrication level }
	Viewstate_Element_Text_DynamicText _dynamicTextVE_TLMV_TitleLine1{ 23, 0, MANUAL_OVERRIDE_VIEW_TEXT_TITLE };
	Viewstate_Element_Text_DynamicText _dynamicTextVE_TLMV_TitleLine2{ 42, 0, DEFAULT_RULE_LINE };
