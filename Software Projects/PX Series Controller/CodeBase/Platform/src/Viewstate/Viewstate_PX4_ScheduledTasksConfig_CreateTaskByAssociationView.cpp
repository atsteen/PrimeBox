...
Viewstate_PX4_ScheduledTasksConfig_CreateTaskByAssociationView::Viewstate_PX4_ScheduledTasksConfig_CreateTaskByAssociationView(IModelTaskData * taskData, IModelViewstateData * viewstateData) :
	_viewstateData(viewstateData), _taskData(taskData), Viewstate_PX4(VIEWSTATEALIAS_SCHEDULED_TASK_CREATE_BY_ASSOCIATION_VIEW){}

char * Viewstate_PX4_ScheduledTasksConfig_CreateTaskByAssociationView::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	...
	Viewstate_Element_Text_DynamicText _dynamicVE_ByIndexLabel{ 22, 0, ViewstateStringAlias::SCH_TASK_CONFIG_CREATE_TEXT_TASKTARGET, SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_CREATE_TYPE_TASK_ELEMENT };
	Viewstate_Element_Text_DynamicText _dynamicVE_TypeLabel{ 24, 0, ViewstateStringAlias::COMPONENT_TEXT_TYPE_LABEL, SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_CREATE_TYPE_TASK_ELEMENT }; 
	...
	if (*selectedRelayIndex >= 0) { additionalOffset = 3; }

	Viewstate_Element_Text_RelayTypeShortName _dynamicVE_RelayType(30 + additionalOffset, 1, currentRelayAssociation->typeAssociation);
	Viewstate_Element_Text_DynamicText _dynamicVE_GroupLabel{ 44, 0, ViewstateStringAlias::COMPONENT_TEXT_GROUP_LABEL, SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_CREATE_GROUP_TASK_ELEMENT };
	Viewstate_Element_Text_StaticText _staticVe_GroupColon(49, 1, ":");
	Viewstate_Element_Text_RelayGroupShortName _dynamicVE_RelayGroup(51, 1, currentRelayAssociation->groupAssociation);
