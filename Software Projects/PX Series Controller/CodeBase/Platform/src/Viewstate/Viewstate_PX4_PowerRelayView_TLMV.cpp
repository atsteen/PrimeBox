...
Viewstate_PX4_PowerRelayView_TLMV::Viewstate_PX4_PowerRelayView_TLMV() : Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_POWER_RELAY_SETTINGS_VIEW_TLMV){}

Viewstate_PX4_PowerRelayView_TLMV::~Viewstate_PX4_PowerRelayView_TLMV(){}

char * Viewstate_PX4_PowerRelayView_TLMV::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	_clearBuffer(vs_OutBuffer, outBufferSize);

	//create viewstate elements { start_index, inbrication level }
	Viewstate_Element_Text_DynamicText _dynamicTextVE_TLMV_TitleLine1{ 22, 0, POWER_RELAY_SETTINGS_VIEW_TEXT_TITLE };
