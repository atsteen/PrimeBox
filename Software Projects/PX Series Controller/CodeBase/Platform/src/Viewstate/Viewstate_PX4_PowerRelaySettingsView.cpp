...
Viewstate_PX4_PowerRelaySettingsView::Viewstate_PX4_PowerRelaySettingsView(IModelViewstateData * viewstateData, IPowerRelayArray * relayArray) :
	Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_POWER_RELAY_SETTINGS_VIEW), _viewstateData(viewstateData), _relayArray(relayArray){}

Viewstate_PX4_PowerRelaySettingsView::~Viewstate_PX4_PowerRelaySettingsView(){}

char * Viewstate_PX4_PowerRelaySettingsView::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	...
	Viewstate_Element_Text_PowerRelayConfigurationList powerRelayList(listStartIndex, 1, _viewstateData, _relayArray);
