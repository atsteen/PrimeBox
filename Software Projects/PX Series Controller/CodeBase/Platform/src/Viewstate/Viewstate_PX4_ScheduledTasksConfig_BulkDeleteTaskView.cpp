...
Viewstate_PX4_ScheduledTasksConfig_BulkDeleteTaskView::Viewstate_PX4_ScheduledTasksConfig_BulkDeleteTaskView(IModelViewstateData * viewstateData)
	: Viewstate_PX4(ViewstateAlias::VIEWSTATEALIAS_SCHEDULED_TASK_BULK_DELETE_TASK_CONF_VIEW), _viewstateData(viewstateData){}

Viewstate_PX4_ScheduledTasksConfig_BulkDeleteTaskView::~Viewstate_PX4_ScheduledTasksConfig_BulkDeleteTaskView(){}

char * Viewstate_PX4_ScheduledTasksConfig_BulkDeleteTaskView::RenderText(char * vs_OutBuffer, const int outBufferSize)
{
	...
	Viewstate_Element_Text_DynamicText _dynamicTextVE_ConfLabel{ 22, 0, SCH_TASK_CONFIG_BULKDELETE_PROMPT_TEXT };
	Viewstate_Element_Text_DynamicText _dynamicTextVE_YesLabel{ 44, 0, DEFAULT_YES_TEXT, SELECTABLE_SCHEDULED_TASK_BULK_DELETE_CONFYES_ELEMENT };
	Viewstate_Element_Text_DynamicText _dynamicTextVE_NoLabel{ 65, 0, DEFAULT_NO_TEXT, SELECTABLE_SCHEDULED_TASK_BULK_DELETE_CONFNO_ELEMENT };
	...
	_vsDynElements.AddElement(&_dynamicTextVE_ConfLabel);
