...
Viewstate_Element_Text_StaticSchdTaskType::Viewstate_Element_Text_StaticSchdTaskType(const int start_index, const int imbricationLevel, const TaskAlias ta) : Viewstate_Element_Text(start_index, imbricationLevel)
{
	_ta = ta;
}

Viewstate_Element_Text_StaticSchdTaskType::~Viewstate_Element_Text_StaticSchdTaskType(){}

int Viewstate_Element_Text_StaticSchdTaskType::emplace(char * target, const int targetlen)
{
	switch (_ta) {
