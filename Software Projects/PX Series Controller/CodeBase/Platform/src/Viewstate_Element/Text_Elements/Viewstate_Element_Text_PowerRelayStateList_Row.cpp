...
Viewstate_Element_Text_PowerRelayStateList_Row::Viewstate_Element_Text_PowerRelayStateList_Row(const int start_index, const int imbricationLevel, const int circuitIndex, const ComponentAssociation association, const ComponentPowerState powerState)
...
Viewstate_Element_Text_PowerRelayStateList_Row::~Viewstate_Element_Text_PowerRelayStateList_Row(){}

int Viewstate_Element_Text_PowerRelayStateList_Row::emplace(char * target, const int targetlen)
{
	...
	//emplace override status at
	Viewstate_Element_Text_ComponentState_Override staticVe_OverrideState(_startIndex + 10, 1, _powerState);
	emplacedCharCount += staticVe_OverrideState.emplace(target, targetlen);

	//emplace powerstate status at
	Viewstate_Element_Text_ComponentState staticVe_PowerState(_startIndex + 14, 1, _powerState);
