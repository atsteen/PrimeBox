...
T_List<ITaskHandler&>* TaskHandlerFactory_PX4::MakeHandlerList()
{
	...
	_taskHandlers.addBack(*new PX4_InputViewstate_ThreeSegmentValue_TaskHandler(_viewstateData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_InputViewstate_BooleanValue_TaskHandler(_viewstateData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_InputViewstate_TimeSpanValue_TaskHandler(_viewstateData, _mapGenerator, _navTonePlayer));
	...
	_taskHandlers.addBack(*new PX4_ManualOverrideViewstate_TaskHandler(_viewstateData, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_EnvironmentSettings_FanCycle_Viewstate_TaskHandler(_viewstateData, _environmentAirData,_mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_EnvironmentSettings_LightCycleView_TaskHandler(_viewstateData, _environmentLightData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_EnvironmentSettings_AlarmThreshold_Viewstate_TaskHandler(_viewstateData, _environmentAirData, _systemData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_PowerRelaySettingsViewstate_TaskHandler(_viewstateData, _powerRelays, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_PowerRelayEditViewstate_TaskHandler(_viewstateData, _mapGenerator, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_CreateView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_CreateTaskSelectView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_CreateTaskConfView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_SetView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _powerRelays, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_EditView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_DeleteView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_DeleteTaskConfView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _navTonePlayer));
	_taskHandlers.addBack(*new PX4_ScheduledTasksConfig_DeleteBulkTaskConfView_TaskHandler(_viewstateData, _taskData, _mapGenerator, _navTonePlayer));
