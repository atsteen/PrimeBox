...
class PX4_ScheduledTasksConfig_SetTaskView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_ScheduledTasksConfig_SetTaskView_Navigate_TaskHandler()
		: TaskHandler(
...
inline bool PX4_ScheduledTasksConfig_SetTaskView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfig_SetTaskView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
	if (_CanHandleTask(ti))
	{
		...
		{
			if(dm->GetSelectedViewstateElement() == SELECTABLE_BACK_ELEMENT){ dm->SetSelectedViewstateElement(SELECTABLE_SCHEDULED_TASKLIST_SET_ELEMENT); }
