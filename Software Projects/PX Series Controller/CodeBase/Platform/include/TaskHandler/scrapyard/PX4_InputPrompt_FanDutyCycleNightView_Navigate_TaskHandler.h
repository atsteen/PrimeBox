...
class PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler()
		: TaskHandler(
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::Handle_NavLeft_Modal(SelectableViewstateElementAlias currentlySelected)
{
	if(currentlySelected == SELECTABLE_SETTHREESEGMENTVALUE_ELEMENT)
	{
		DataModel_PX4::GetInstance().AdjustFanDutyCycleNight(-1);
		this->GetBuzzer()->playNavTone();
		return true;
	}
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_InputPrompt_FanDutyCycleNightView_Navigate_TaskHandler::Handle_NavRight_Modal(SelectableViewstateElementAlias currentlySelected)
{
	if (currentlySelected == SELECTABLE_SETTHREESEGMENTVALUE_ELEMENT)
	{
		DataModel_PX4::GetInstance().AdjustFanDutyCycleNight(1);
