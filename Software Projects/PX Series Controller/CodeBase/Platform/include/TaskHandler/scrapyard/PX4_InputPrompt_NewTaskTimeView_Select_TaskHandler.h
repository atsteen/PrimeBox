...
class PX4_InputPrompt_NewTaskTimeView_Select_TaskHandler
	: public TaskHandler
{
public:
	PX4_InputPrompt_NewTaskTimeView_Select_TaskHandler()
		: TaskHandler(
...
inline bool PX4_InputPrompt_NewTaskTimeView_Select_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_InputPrompt_NewTaskTimeView_Select_TaskHandler::HandleTask(TaskItem * ti)
{
	if (_CanHandleTask(ti))
	{
		...
		case SELECTABLE_BACK_ELEMENT:
			...
			DataModel_PX4::GetInstance().SetSelectedViewstateElement(SELECTABLE_SCHEDULED_TASK_TASK_TIME_ELEMENT, true);
