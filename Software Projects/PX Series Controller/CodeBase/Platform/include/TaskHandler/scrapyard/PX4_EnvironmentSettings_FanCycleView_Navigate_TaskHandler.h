...
class PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler()
		: TaskHandler(
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_DAY_FAN_DUTY_SET_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_NIGHT_FAN_DUTY_SET_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_FAN_CYCLE_SET_ELEMENT
	};
...
inline bool PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_EnvironmentSettings_FanCycleView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
