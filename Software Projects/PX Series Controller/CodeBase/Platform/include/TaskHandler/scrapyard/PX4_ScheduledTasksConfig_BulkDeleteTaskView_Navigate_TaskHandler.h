...
class PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler()
		: TaskHandler(
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_BULK_DELETE_CONFYES_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_BULK_DELETE_CONFNO_ELEMENT,
	};
...
inline bool PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_ScheduledTasksConfig_BulkDeleteTaskView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
