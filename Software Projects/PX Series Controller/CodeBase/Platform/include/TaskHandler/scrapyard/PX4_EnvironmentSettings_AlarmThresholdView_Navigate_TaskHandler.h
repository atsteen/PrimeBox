...
class PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler()
		: TaskHandler(
			TaskAlias::TASKALIAS_NOT_SET, //Leave TASKALIAS_NOT_SET to handle both navLeft and navRight
			ViewstateAlias::VIEWSTATEALIAS_ENVIRONMENT_ALARM_THRESHOLDS_VIEW,
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_OVERTEMP_ALARM_SET_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_OVERHUM_ALARM_SET_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_ENVIRONMENT_LOGFULL_ALARM_SET_ELEMENT
	};
...
inline bool PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_EnvironmentSettings_AlarmThresholdView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
