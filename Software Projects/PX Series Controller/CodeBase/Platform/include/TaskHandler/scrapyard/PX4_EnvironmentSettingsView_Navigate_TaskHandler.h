...
class PX4_EnvironmentSettingsView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_EnvironmentSettingsView_Navigate_TaskHandler()
		: TaskHandler(
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_ENVIRONMENT_SUNRISE_SUNSET_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_ENVIRONMENT_AIR_CIRC_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_ENVIRONMENT_ALARM_THRESHOLDS_ELEMENT
	};
...
inline bool PX4_EnvironmentSettingsView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettingsView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_EnvironmentSettingsView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_EnvironmentSettingsView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
