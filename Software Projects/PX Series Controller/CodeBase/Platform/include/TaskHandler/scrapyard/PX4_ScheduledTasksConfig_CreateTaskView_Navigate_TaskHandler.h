...
class PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler()
		: TaskHandler(
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_TASK_TYPE_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_TASK_TIME_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_SCHEDULED_TASK_TASK_SAVE_ELEMENT
	};
...
inline bool PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_ScheduledTasksConfig_CreateTaskView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
