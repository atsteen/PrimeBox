...
class PX4_ScheduledTasksConfigView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_ScheduledTasksConfigView_Navigate_TaskHandler()
		: TaskHandler(
			TaskAlias::TASKALIAS_NOT_SET, //Leave TASKALIAS_NOT_SET to handle both navLeft and navRight
			ViewstateAlias::VIEWSTATEALIAS_SCHEDULED_TASK_CONFIGURATION_VIEW,
...
protected:
	SelectableViewstateElementAlias _selectableOrder[SELECTABLE_ELEMENT_COUNT]{
		...
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_SCHD_TASK_SET_EXISTING_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_SCHD_TASK_EDIT_EXISTING_ELEMENT,
		SelectableViewstateElementAlias::SELECTABLE_MENU_SELECT_SCHD_TASK_CREATE_DELETE_ELEMENT
	};
...
inline bool PX4_ScheduledTasksConfigView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfigView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_ScheduledTasksConfigView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_ScheduledTasksConfigView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
