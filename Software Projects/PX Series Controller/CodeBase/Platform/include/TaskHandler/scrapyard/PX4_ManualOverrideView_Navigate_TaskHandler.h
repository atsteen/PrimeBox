...
class PX4_ManualOverrideView_Navigate_TaskHandler
	: public TaskHandler
{
public:
	PX4_ManualOverrideView_Navigate_TaskHandler()
		: TaskHandler(
...
inline bool PX4_ManualOverrideView_Navigate_TaskHandler::HandleTask(TaskItem * ti)
{
...
inline bool PX4_ManualOverrideView_Navigate_TaskHandler::_CanHandleTask(TaskItem * ti)
{
...
inline bool PX4_ManualOverrideView_Navigate_TaskHandler::Handle_NavLeft(SelectableViewstateElementAlias currentlySelected)
{
...
inline bool PX4_ManualOverrideView_Navigate_TaskHandler::Handle_NavRight(SelectableViewstateElementAlias currentlySelected)
{
