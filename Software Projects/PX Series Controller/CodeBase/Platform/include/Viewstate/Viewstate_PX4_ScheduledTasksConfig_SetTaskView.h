...
class Viewstate_PX4_ScheduledTasksConfig_SetTaskView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_SetTaskView(IModelViewstateData * viewstateData, IModelTaskData * taskData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_SetTaskView() override;
