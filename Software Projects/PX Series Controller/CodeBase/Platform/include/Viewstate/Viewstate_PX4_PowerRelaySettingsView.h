...
class Viewstate_PX4_PowerRelaySettingsView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_PowerRelaySettingsView(IModelViewstateData * viewstateData, IPowerRelayArray * relayArray);
	virtual ~Viewstate_PX4_PowerRelaySettingsView() override;
