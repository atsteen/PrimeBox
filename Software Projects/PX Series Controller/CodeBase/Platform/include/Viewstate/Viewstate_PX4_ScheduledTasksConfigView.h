...
class Viewstate_PX4_ScheduledTasksConfigView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfigView(IModelViewstateData * viewstateData);
	virtual ~Viewstate_PX4_ScheduledTasksConfigView() override;
