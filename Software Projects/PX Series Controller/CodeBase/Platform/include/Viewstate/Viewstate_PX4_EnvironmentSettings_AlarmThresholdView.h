...
#include "..\..\include\SharedStructure\SharedInterface\IModelSystemData.h"
...
class Viewstate_PX4_EnvironmentSettings_AlarmThresholdView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_EnvironmentSettings_AlarmThresholdView(IModelEnvAirData *, IModelSystemData *, IModelViewstateData *);
	virtual ~Viewstate_PX4_EnvironmentSettings_AlarmThresholdView() override;
