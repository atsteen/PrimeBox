...
class Viewstate_PX4_ScheduledTasksConfig_EditTaskView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_EditTaskView(IModelViewstateData * viewstateData, IModelTaskData * taskData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_EditTaskView() override;
