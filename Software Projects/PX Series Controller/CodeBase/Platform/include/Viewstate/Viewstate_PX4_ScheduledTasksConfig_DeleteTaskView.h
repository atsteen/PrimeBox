...
class Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView(IModelViewstateData * viewstateData, IModelTaskData * taskData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_DeleteTaskView() override;
