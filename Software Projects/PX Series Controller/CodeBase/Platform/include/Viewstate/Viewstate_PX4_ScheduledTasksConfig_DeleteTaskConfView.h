...
class Viewstate_PX4_ScheduledTasksConfig_DeleteTaskConfView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_DeleteTaskConfView(IModelViewstateData * viewstateData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_DeleteTaskConfView() override;
