...
class Viewstate_PX4_ManualOverrideView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ManualOverrideView(IModelViewstateData * viewstateData, IPowerRelayArray * relayArray);
	virtual ~Viewstate_PX4_ManualOverrideView() override;
