...
class Viewstate_PX4_EnvironmentSettingsView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_EnvironmentSettingsView(IModelViewstateData * viewstateData);
	virtual ~Viewstate_PX4_EnvironmentSettingsView() override;
