...
class Viewstate_PX4_ScheduledTasksConfig_CreateTaskView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_CreateTaskView(IModelTaskData * taskData, IModelViewstateData * viewstateData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_CreateTaskView() override;
