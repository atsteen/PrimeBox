...
class Viewstate_PX4_ScheduledTasksConfig_CreateTaskSelectView :
	public Viewstate_PX4
{
public:
	Viewstate_PX4_ScheduledTasksConfig_CreateTaskSelectView(IModelTaskData * taskData, IModelViewstateData * viewstateData);
	virtual ~Viewstate_PX4_ScheduledTasksConfig_CreateTaskSelectView() override;
