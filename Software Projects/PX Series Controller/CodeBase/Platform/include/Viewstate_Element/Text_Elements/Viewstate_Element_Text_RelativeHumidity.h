...
class Viewstate_Element_Text_RelativeHumidity :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_RelativeHumidity(const int, const int, IAirSensor *);
	~Viewstate_Element_Text_RelativeHumidity();
