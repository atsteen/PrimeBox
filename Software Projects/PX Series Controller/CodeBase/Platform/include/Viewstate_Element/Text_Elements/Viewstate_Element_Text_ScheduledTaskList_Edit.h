...
class Viewstate_Element_Text_ScheduledTaskList_Edit :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_ScheduledTaskList_Edit(const int start_index, const int imbricationLevel, IModelTaskData * taskData, IModelViewstateData * viewstateData);
	~Viewstate_Element_Text_ScheduledTaskList_Edit();
