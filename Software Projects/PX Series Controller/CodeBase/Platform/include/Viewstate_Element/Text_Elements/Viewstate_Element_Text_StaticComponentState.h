...
class Viewstate_Element_Text_StaticComponentState :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_StaticComponentState(const int, const int, const bool);
	~Viewstate_Element_Text_StaticComponentState();
