...
class Viewstate_Element_Text_PowerRelayStateList :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_PowerRelayStateList(const int start_index, const int imbricationLevel, IModelViewstateData * viewstateData, IPowerRelayArray * powerRelays);
	~Viewstate_Element_Text_PowerRelayStateList();
