...
class Viewstate_Element_Text_PowerRelayStateEvent :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_PowerRelayStateEvent(const int start_index, const int imbricationLevel, const int circuitIndex, const ComponentAssociation association, const ComponentPowerState powerState);
	~Viewstate_Element_Text_PowerRelayStateEvent();
