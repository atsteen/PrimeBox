...
class Viewstate_Element_Text_SchdTaskType :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_SchdTaskType(const int, const int, const TaskAlias);
	~Viewstate_Element_Text_SchdTaskType();

	virtual int emplace(char *, const int) override;

protected:
	const TaskAlias _taskAlias;
};