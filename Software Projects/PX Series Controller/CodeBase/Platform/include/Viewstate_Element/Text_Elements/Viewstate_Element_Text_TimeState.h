...
class Viewstate_Element_Text_TimeState :
	public Viewstate_Element_Text
{
public:
	Viewstate_Element_Text_TimeState(const int, const int, const TimeSignature);
	~Viewstate_Element_Text_TimeState();

	virtual int emplace(char *, const int) override;

protected:
	TimeSignature _timeState;
};